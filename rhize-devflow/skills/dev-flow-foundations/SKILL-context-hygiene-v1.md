...
## Quick Context
- Dual repo: frontend-repo (Next.js frontend) + backend-repo (Payload CMS backend)
...
| API | backend-repo/docs/API.md | Backend integration |
...
- Switching between frontend (frontend-repo) and backend (backend-repo) work
