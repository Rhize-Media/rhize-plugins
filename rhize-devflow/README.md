...
|---|---|---|
| `/rhize-devflow:impact-map` | 1 — map | Compact (≤500 words) CodeGraph-first executable contract paired with a semantic impact map; detailed examples and troubleshooting load on demand from [`docs/impact-map-reference.md`](docs/impact-map-reference.md). It preserves deterministic `rg` fallback, preparation, and graph/diff/map reconciliation. |
