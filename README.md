...
| [rhize-ops](./rhize-ops) ⭐ **hub — recommended base install** | 0.13.2 | 3 | Operations skill set for delegation, hand-offs, team workflow automation, and privacy-safe parallel-agent optimization. Includes one-strategy live execution plus explicit isolated comparisons of baseline, ECC, Superpowers, and the Rhize routing policy. | [README](./rhize-ops/README.md) · [GUIDE](./rhize-ops/GUIDE.md) |
