...
| [rhize-tasks](./rhize-tasks) | 0.2.0 | 6 | Local-first unified planning for approved Jira work across Google Calendar and Apple Reminders, with structured Slack fallback, bounded replanning, and human approval controls | [README](./rhize-tasks/README.md) · [GUIDE](./rhize-tasks/GUIDE.md) |
<!-- SKILL-MAP:END -->
