...
| [rhize-ops](./rhize-ops) ⭐ **hub — recommended base install** | 0.15.0 | 3 | Operations skill set for delegation, hand-offs, and privacy-safe parallel-agent work with self-contained Rhize routing, ephemeral task-graph validation, and terminal v2 evidence receipts | [README](./rhize-ops/README.md) · [GUIDE](./rhize-ops/GUIDE.md) |
