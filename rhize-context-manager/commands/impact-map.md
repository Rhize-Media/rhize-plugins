...
- `/done` — final verification after reconciliation.
- `/context-hygiene` — preserve the map when work crosses a session boundary.
- `dev-flow-foundations` in `rhize-devflow` — rationale and reusable impact-analysis principles.
