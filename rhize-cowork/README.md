...
| Skill | What it does |
| --- | --- |
| [`project-kickoff`](./skills/project-kickoff/SKILL.md) | Scaffolds the four standard project context files — `CLAUDE.md` (operating manual), `BUSINESS.md` (business/offer/market), `PERSONALITY.md` (brand voice & tone), `INFO.md` (links, tools, people) — for a new Cowork project. Works from a website, from strategy/brand docs, or from nothing via a guided interview. |
